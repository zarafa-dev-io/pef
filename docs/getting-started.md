...
2. Tapez `/` : la liste des prompts du dépôt apparaît (ils viennent de `.github/prompts/` — la liste complète des 21 Processors est dans [la page Processors](processors.md)).
